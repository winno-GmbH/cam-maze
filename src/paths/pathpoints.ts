...
const pacmanHomePathPoints: MazePathPoint[] = [
  ...
  },
  {
    ...
    curveCheckPoints: [
      ...
      new THREE.Vector3(-0.14675, 0.55, 1.105),
      new THREE.Vector3(-0.04625, 0.55, 1.0045),
    ],
  },
  {
...
const ghost1HomePathPoints: MazePathPoint[] = [
  ...
  },
  {
    ...
    curveCheckPoints: [
      ...
      new THREE.Vector3(0.95875, 0.55, 0.8035),
  ...
  },
  {
    ...
    type: "straight",
    curveCheckPoints: [
      new THREE.Vector3(0.25525, 0.55, 0.502),
      new THREE.Vector3(0.15475, 0.55, 0.6025),
      new THREE.Vector3(0.05425, 0.55, 0.703),
      new THREE.Vector3(0.004, 0.55, 0.8035),
      new THREE.Vector3(-0.04625, 0.55, 0.904),
      new THREE.Vector3(0.05425, 0.55, 1.0045),
      new THREE.Vector3(0.15475, 0.55, 1.105),
      new THREE.Vector3(0.05425, 0.55, 1.2055),
      new THREE.Vector3(-0.04625, 0.55, 1.2055),
      new THREE.Vector3(-0.14675, 0.55, 1.105),
      new THREE.Vector3(-0.0965, 0.55, 1.0045),
      new THREE.Vector3(-0.04625, 0.55, 0.904),
      new THREE.Vector3(-0.14675, 0.55, 0.8035),
    ],
  },
  { pos: new THREE.Vector3(-0.44825, 0.55, 0.703), type: "straight" },
];
